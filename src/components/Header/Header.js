                ...
                <Box className={`mega-menu ${isMegaActive ? 'mega-menu-active' : ''}`}>
                  <List className='mega-menu-list'>
                    <ListItem  className='mega-menu-list-item'  onClick={toggleDropServices}  >
                      ...
                      <span className={`mega-expand ${isServicesActive ? 'mega-expand-plus-active' : ''}`}>+</span>
                      <span className={`mega-expand ${isServicesActive ? 'mega-expand-minus-active' : ''}`} >-</span>
                    </ListItem>
                    <ListItem className='mega-menu-list-item' onClick={toggleDropProducts}  >
                      ...
                      <span  className={`mega-expand ${isProductsActive ? 'mega-expand-plus-active' : ''}`}>+</span>
                      <span className={`mega-expand ${isProductsActive ? 'mega-expand-minus-active' : ''}`} >-</span>
                    </ListItem>
                    ...
                    <ListItem className='mega-menu-list-item' onClick={toggleDropCompany}  >
                      ...
                      <span  className={`mega-expand ${isCompanyActive ? 'mega-expand-plus-active' : ''}`}>+</span>
                      <span  className={`mega-expand ${isCompanyActive ? 'mega-expand-minus-active' : ''}`} >-</span>
                    </ListItem>
                  </List>
                </Box>
              </Box>
